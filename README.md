...
values-mk-rMK, values-night, values-sl-rSI: Configuration folders for different locales and themes (e.g., Macedonian, Slovenian, Night mode).
- values: A standard folder for storing XML files that define values like colors, dimensions, strings, and styles.

`./app/src/main/java/si/um/feri/fitness` contains application activities
